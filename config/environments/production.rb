...
Rails.application.configure do
  ...
  # Ractor experiment: with :null_store fragment caching is already a no-op;
  # disabling perform_caching skips fragment cache-key computation (which would
  # otherwise run collection cache-version DB queries during rendering).
